...
root_agent = LlmAgent(
    ...
    instruction="""
        ...
        "1. Use receipt_ingestion_agent to handle initial receipt uploads and data extraction. Delegate to This agent Only when The image is given otherwise don't move to This agent\n  "
